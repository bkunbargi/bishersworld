...
class InstagramAPI:
    ...
    def login(self, force=False, repeat_request=True):
        is_logged = False
        ...
        if (not self.isLoggedIn or force):
            ...
            try:
                if (self.SendRequest('si/fetch_headers/?challenge_type=signup&guid=' + self.generateUUID(False), None, True, repeat_request)):
                    ...
                    if (self.SendRequest('accounts/login/', self.generateSignature(json.dumps(data)), True, repeat_request)):
    ...
    def SendRequest(self, endpoint, post=None, login=False, repeat_request=True):
